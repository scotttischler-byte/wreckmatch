...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/about/team.txt`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/about/kathy-carr`, lastModified: now, changeFrequency: "monthly", priority: 0.65 },
    { url: `${base}/about/kathy-carr/profile.txt`, lastModified: now, changeFrequency: "monthly", priority: 0.55 },
    { url: `${base}/about/scott-tischler`, lastModified: now, changeFrequency: "monthly", priority: 0.65 },
    { url: `${base}/about/scott-tischler/profile.txt`, lastModified: now, changeFrequency: "monthly", priority: 0.55 },
    { url: `${base}/about/roy-waddell`, lastModified: now, changeFrequency: "monthly", priority: 0.65 },
    { url: `${base}/about/roy-waddell/profile.txt`, lastModified: now, changeFrequency: "monthly", priority: 0.55 },
