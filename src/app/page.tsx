  ...
  return (
    <>
      ...
      <button
          ...
          try {
            const res = await fetch(url, {
              ...
              body: JSON.stringify({
                ...
                phone: "(555) 555-1234",
                accidentDate: "May 11, 2026",
                accidentLocation: "Colgate, Wisconsin",
                crashType: "Rear end",
                injuries: "Yes",
                medicalCare: "None yet",
                insuranceStatus: "Not sure",
                hasLawyer: "No"
              })
            });
            if (res.ok) {
              alert("✅ Test payload sent to GHL. Go back to GHL now - Mapping Reference should appear.");
            } else {
        ...
        className="fixed bottom-8 right-8 bg-red-600 hover:bg-red-700 text-white text-lg font-bold px-8 py-5 rounded-3xl shadow-2xl z-[99999] flex items-center gap-2"
      >
