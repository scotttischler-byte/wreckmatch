export const en = {
  ...
  form: {
    ...
    intake: {
      ...
      sectionHint: "Quick answers help us connect you with the right resources faster.",
      ...
      hasAttorney: "Do you already have an attorney?",
      selectOne: "Select one",
      yes: "Yes",
      no: "No",
      notSure: "Not sure",
      whenTodayYesterday: "Today or yesterday",
      whenThisWeek: "Within the past week",
      whenWithin30Days: "Within the past 30 days",
      whenOneToThreeMonths: "1–3 months ago",
      whenThreeToTwelveMonths: "3–12 months ago",
      whenOverAYear: "More than a year ago",
