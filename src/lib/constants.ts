...
/** Retell embed (layout) — voice callback widget identifiers now come from env only. */
export const RETELL_EMBED_PUBLIC_KEY = process.env.NEXT_PUBLIC_RETELL_PUBLIC_KEY ?? "";
...
export const RETELL_VOICE_AGENT_ID = process.env.NEXT_PUBLIC_RETELL_VOICE_AGENT_ID ?? "";

/** @deprecated Chat agent id unused in layout; retained for tooling/docs during migration */
export const RETELL_CHAT_AGENT_ID = process.env.NEXT_PUBLIC_RETELL_CHAT_AGENT_ID ?? "";
