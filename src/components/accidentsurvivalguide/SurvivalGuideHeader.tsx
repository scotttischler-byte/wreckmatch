...
export function SurvivalGuideHeader() {
  ...
  const NAV_LINKS = [
    ...
    { href: "/webinar", label: nav.masterclass },
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-asg-border/60 bg-asg-surface/95 shadow-sm shadow-asg-navy/[0.04] backdrop-blur-md">
